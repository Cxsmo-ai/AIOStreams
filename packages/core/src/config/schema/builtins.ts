...
export const builtinsSchema = {
  ...
  harbrr: {
    url: {
      ...
      default: null,
      label: 'Harbrr URL',
      env: 'BUILTIN_HARBRR_URL',
      description: 'Base URL for the Harbrr built-in addon.',
      requiresRestart: false,
      secret: false,
    },
    apiKey: {
      schema: nullableString,
      default: null,
      label: 'Harbrr API key',
      env: 'BUILTIN_HARBRR_API_KEY',
      description: 'API key for the Harbrr built-in addon.',
      requiresRestart: false,
      secret: true,
    },
    indexers: {
      schema: commaSeparatedList,
      default: [] as string[],
      label: 'Harbrr indexers',
      env: 'BUILTIN_HARBRR_INDEXERS',
      description: 'Comma-separated list of Harbrr indexers to query.',
      requiresRestart: false,
      secret: false,
    },
    defaultTimeout: {
      schema: optionalPositiveInt,
      default: null,
      label: 'Harbrr default timeout (ms)',
      env: 'BUILTIN_DEFAULT_HARBRR_TIMEOUT',
      description: 'Default timeout for Harbrr requests.',
      requiresRestart: false,
      secret: false,
    },
    searchTimeout: {
      schema: positiveInt,
      default: 30000,
      label: 'Harbrr search timeout (ms)',
      env: 'BUILTIN_HARBRR_SEARCH_TIMEOUT',
      description: 'Timeout for Harbrr search requests.',
      requiresRestart: false,
      secret: false,
    },
    searchCacheTtl: {
      schema: seconds,
      default: Week,
      label: 'Harbrr search cache TTL (s)',
      env: 'BUILTIN_HARBRR_SEARCH_CACHE_TTL',
      description: 'Cache TTL for Harbrr search results.',
      requiresRestart: false,
      secret: false,
    },
    indexersCacheTtl: {
      schema: seconds,
      default: 14 * Day,
      label: 'Harbrr indexers cache TTL (s)',
      env: 'BUILTIN_HARBRR_INDEXERS_CACHE_TTL',
      description: 'Cache TTL for the Harbrr indexers list.',
      requiresRestart: false,
      secret: false,
    },
  },
